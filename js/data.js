...
window.TRAVEL_DATA = [
  ...
  {id:2,name:'Karachi → Hunza Trek',type:'mountain',price:799,popularity:89,rating:4.8,duration:7,hero:'assets/Karachi Hunza Trek.jpg',description:'Guided trek across the scenic Karakoram range.'},
  {id:3,name:'Istanbul City Break',type:'city',price:499,popularity:82,rating:4.5,duration:3,hero:'assets/Istanbul City Break.jpg',description:'Historic city tour, Bosphorus cruise and culinary experiences.'},
  {id:4,name:'Sri Lanka Surf & Culture',type:'beach',price:649,popularity:76,rating:4.4,duration:6,hero:'assets/Sri Lanka Surf & Culture.jpg',description:'Surf lessons, tea plantation visit and wildlife safari.'},
  ...
  {id:7,name:'Thailand Island Hopper',type:'beach',price:549,popularity:84,rating:4.5,duration:6,hero:'assets/Thailand Island Hopper.jpg',description:'Island hopping across Phi Phi and Phuket with boat rides.'},
  ...
  {id:9,name:'Tokyo Urban Experience',type:'city',price:799,popularity:80,rating:4.7,duration:5,hero:'assets/Tokyo Urban Experience.jpg',description:'Technology tours, food markets, and cultural visits.'},
  {id:10,name:'Amazon Rainforest Lodge',type:'adventure',price:1199,popularity:69,rating:4.6,duration:8,hero:'assets/Amazon Rainforest Lodge.jpg',description:'Wildlife, river safaris and guided nature walks.'},
  ...
  {id:15,name:'Swiss Alps Skiing',type:'mountain',price:2199,popularity:94,rating:4.9,duration:7,hero:'assets/Swiss Alps Skiing.jpg',description:'World-class skiing and cozy chalets in the Swiss Alps.'},
  ...
  {id:17,name:'African Safari',type:'adventure',price:2499,popularity:89,rating:4.9,duration:10,hero:'assets/African Safari.jpg',description:'Witness the majesty of African wildlife in their natural habitat.'},
  {id:18,name:'Kyoto Cherry Blossoms',type:'city',price:1699,popularity:91,rating:4.8,duration:8,hero:'assets/Kyoto Cherry Blossoms.jpg',description:'Walk through blooming cherry blossom tunnels in historic Kyoto.'}
];
